  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        hankeit: {
          navy: "hsl(var(--hankeit-navy))",
          cream: "hsl(var(--hankeit-cream))",
          steel: "hsl(var(--hankeit-steel))",
          light: "hsl(var(--hankeit-light))",
          gray: "hsl(var(--hankeit-gray))",
          sky: "hsl(var(--hankeit-sky))",
          ice: "hsl(var(--hankeit-ice))",
          deep: "hsl(var(--hankeit-deep))",
        },
        ticker: {
